  ...
  const filteredOptions = options
    .filter((opt) => {
      if (
        ...
        return opt[dependentKey] === dependentValue;
      }
      return true; // no dependentValue, keep all
    })
      ...
      <div className="flex flex-col">
        ...
        <div className="relative">
          <div
            ...
            } border rounded-lg px-2 py-2 cursor-pointer bg-text-input-color hover:border-border-dark-color flex items-center justify-between ${
